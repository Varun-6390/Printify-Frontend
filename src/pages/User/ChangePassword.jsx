...
const ChangepassUser = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-8 text-white">
      ...
      {/* CARD */}
      <div className="relative z-10 w-full max-w-lg p-10 rounded-2xl 
                      backdrop-blur-2xl bg-white/10 border border-white/20 shadow-2xl">

        <h2 className="text-4xl font-light text-center mb-8 tracking-wide">
        ...
        <form onSubmit={submitChange} className="space-y-6">
          ...
          {/* OLD PASSWORD */}
          <div>
            <label className="text-gray-300 font-light">Old Password</label>
            <input
              type="password"
              name="op"
              value={form.op}
              ...
              required
              className="mt-2 w-full px-4 py-3 rounded-lg bg-white/5 border border-white/20 
          ...
          {/* NEW PASSWORD */}
          <div>
            <label className="text-gray-300 font-light">New Password</label>
            <input
              type="password"
              name="np"
              value={form.np}
          ...
          {/* CONFIRM PASSWORD */}
          <div>
            <label className="text-gray-300 font-light">Confirm Password</label>
            <input
              type="password"
              name="cnp"
              value={form.cnp}
          ...
          <button
            type="submit"
            className="w-full py-3 text-lg rounded-lg font-semibold bg-teal-400 text-black 
